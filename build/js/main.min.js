...
var _dropmenu = require("./modules/dropmenu");
...
var _focus = require("./modules/focus");
var _autoResizeTextarea = require("./vendor/auto-resize-textarea");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  (0, _newsFilter.replaceCurrentClass)();
  (0, _sliders.createHeroSlider)();
  (0, _sliders.createProgramsSlider)();
  (0, _sliders.createNewsSlider)();
  (0, _sliders.createReviewsSlider)();
  (0, _iosVhFix.iosVhFix)();
  (0, _menu.effectMenu)();
  (0, _dropmenu.effectDropMenu)();
  (0, _initAccordion.initAccordions)();
  (0, _map.initmap)();
  (0, _focus.replaceFocus)();
...
},{"./modules/dropmenu":2,"./modules/focus":3,"./modules/form-validate/form":5,"./modules/map":11,"./modules/menu":12,"./modules/modals/init-modals":13,"./modules/news-filter":15,"./modules/sliders":16,"./select/custom-select":18,"./utils/ios-vh-fix":22,"./vendor/auto-resize-textarea":25,"./vendor/init-accordion":26}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.effectDropMenu = void 0;
var navDropmenuButtons = document.querySelectorAll('.nav__button-dropdown');
var nav = document.querySelector('.nav');
var closeMenu = function closeMenu(elementItem) {
...
var openMenu = function openMenu(elementItem) {
...
var effectDropMenu = function effectDropMenu() {
  if (document.body.contains(document.querySelector('.nav__item-dropdown'))) {
    navDropmenuButtons.forEach(function (navDropmenuButton) {
      return navDropmenuButton.addEventListener('click', function () {
        var dropMenu = navDropmenuButton.parentElement;
...
exports.effectDropMenu = effectDropMenu;
...
exports.replaceFocus = void 0;
var menu = document.querySelector('.nav__btn');
var navFirstItem = document.querySelector('.nav__first-item');
var navLastItem = document.querySelector('.nav__last-item');
var navMenu = document.querySelector('#nav');
var recycleFocus = function recycleFocus(lastItem, firstItem) {
  lastItem.addEventListener('blur', function () {
    firstItem.focus();
  });
};
var replaceFocus = function replaceFocus() {
  menu.addEventListener('blur', function () {
    if (navMenu.classList.contains('nav--opened')) {
      navFirstItem.focus();
      recycleFocus(navLastItem, navFirstItem);
    } else {
      var activeSlider = document.querySelector('.hero__slider.swiper-slide-active');
      activeSlider.focus();
    }
  });
};
exports.replaceFocus = replaceFocus;
...
var onDocumentEscape = function onDocumentEscape(evt) {
  if (evt.key === 'Escape') {
    closeMenu();
  } else {
    return;
...
var effectMenu = function effectMenu() {
...
exports.replaceCurrentClass = void 0;
var container = document.querySelector('.news__buttons-wrapper');
var currentButton = container.querySelector('.news__button--current');
var replaceCurrentClass = function replaceCurrentClass() {
...
exports.replaceCurrentClass = replaceCurrentClass;
...
exports.createReviewsSlider = exports.createProgramsSlider = exports.createNewsSlider = exports.createHeroSlider = void 0;
var Swiper = window.Swiper;
var elementHero = document.querySelector('.swiper--1');
...
var elementPrograms = document.querySelector('.swiper--2');
...
var createNewsSlider = function createNewsSlider() {
  if (elementNews) {
    /* eslint-disable */
    var newSwiper = new Swiper('.news__swiper', {
      /* eslint-enable */
      speed: 1500,
      loop: false,
      breakpoints: {
      ...
      on: {
        ...
        init: function init() {
          /* eslint-enable */
          var newsBtns = document.querySelectorAll('.news__button');
          var newsItems = document.querySelectorAll('.news__slider');
          var activeBtn = 'all';
          ...
          newsBtns.forEach(function (newsBtn) {
...
var elementReviews = document.querySelector('.swiper--4');
