...
},{"./modules/dropmenu":2,"./modules/focus":3,"./modules/form-validate/form":5,"./modules/map":11,"./modules/menu":12,"./modules/modals/init-modals":13,"./modules/news-filter":15,"./modules/sliders":16,"./select/custom-select":18,"./utils/ios-vh-fix":22,"./vendor/init-accordion":25}],2:[function(require,module,exports){
"use strict";
...
var replaceFocus = function replaceFocus() {
  menu.addEventListener('blur', function () {
    if (navMenu.classList.contains('nav--opened')) {
      ...
      var activeSlider = document.querySelector('.hero__slider.hero-slider.swiper-slide.swiper-slide-visible.swiper-slide-active');
      activeSlider.focus();
    }
  });
};
